...
class ExcelGeneratorServiceSyncfusionImpl extends ExcelGeneratorService {
  ...
  Future<void> generateExcelFile(List<Activo> activos) async {
    ...
    for (final activo in activos) {
      ...
      sheet.getRangeByIndex(rowIndex, 9).setText(activo.criticalityDescription);
      ...
      sheet.getRangeByIndex(rowIndex, 16).setText(activo.state);
      ...
      sheet.getRangeByIndex(rowIndex, 19).setText(activo.classification);
      sheet
      ...
      for (final image in activo.images) {
        ...
        // sheet.getRangeByIndex(rowIndex, columnIndex).rowHeight = 88.0;
        columnIndex++;
        pictureIndex++;
      }
